const STRINGS = {
  ...
  en: {
    ...
    briefingContext: 'Per site supervisor instructions, an RC beam (2,500 kg) will be lifted to the 3rd floor slab position. Walk the site and perform required safety actions before lifting.',
    briefingStep1:   'Sling inspection · Pin secured · Spec review · Angle measurement',
    briefingStep2:   'Signal person positioned · Danger zone worker evacuated',
    briefingStep3:   'Board the crane cab → Start lift',
