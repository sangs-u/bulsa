...
const GLOBAL_ACCIDENTS = {
  ...
  falling_debris: {
    ...
    descVi: 'Mảnh vữa/ván khuôn từ tầng trên rơi xuống làm bị thương công nhân ở dưới.',
    descAr: 'سقط حطام الخرسانة/القوالب من الطابق العلوي وأصاب عاملاً في الأسفل.',
    causeKo: '수직 동시작업 미통제 / 낙하물방지망 부재 / 출입통제 미실시',
    causeEn: 'Uncontrolled vertical concurrent work / no debris net / no access control',
    causeVi: 'Công việc đồng thời theo chiều dọc không kiểm soát / không có lưới chống vật rơi / không hạn chế tiếp cận',
    causeAr: 'عمل عمودي متزامن غير محكوم / غياب شبكة الحماية / غياب التحكم بالدخول',
    lawKo: '산업안전보건기준 제14조 (낙하물에 의한 위험의 방지)\n제20조 (출입의 금지)\nKOSHA GUIDE C-50-2017',
    lawEn: 'OSH Rule §14 (Falling object protection)\n§20 (Access prohibition)',
    lawVi: 'Quy chuẩn ATVSLĐ §14 (Phòng vật rơi)\n§20 (Cấm tiếp cận)',
    lawAr: 'قاعدة السلامة §14 (الحماية من الأجسام الساقطة)\n§20 (منع الدخول)',
    procedureKo: [
    ...
    procedureVi: [
      'Sơ tán tất cả công nhân ở phía dưới và hạn chế tiếp cận',
      'Lắp lưới chống vật rơi nằm ngang (nhô ra 1,8 m)',
      'Lắp lan can và chắn chân tại mép sàn trên',
      'Chỉ tiếp tục khi đã bố trí người ra hiệu/giám sát',
    ],
    procedureAr: [
      'إخلاء جميع العمال أسفل منطقة العمل ومنع الدخول',
      'تركيب شبكة حماية أفقية بطول 1.8 م',
      'تركيب الحواجز والقواعد عند حافة الطابق العلوي',
      'استئناف العمل فقط بعد تعيين مُوجِّه/مراقب',
    ],
  },
  fire_explosion: {
    ...
    descVi: 'Hơi dung môi gần khu vực sơn bị bắt lửa từ tia lửa điện/lửa hàn gây cháy nổ.',
    descAr: 'اشتعلت أبخرة المذيب قرب منطقة الدهان من شرارة كهربائية/لهب لحام مما تسبب بحريق وانفجار.',
    ...
    causeVi: 'Dung môi + nguồn lửa trong vòng 5 m / không thông gió / không đo nồng độ LEL',
    causeAr: 'مذيب + مصدر اشتعال خلال 5 م / غياب التهوية / غياب قياس LEL',
    lawKo: '산업안전보건기준 제232조 (화재·폭발 방지)\n제236조 (화재위험작업의 통제)',
    lawEn: 'OSH Rule §232 (Fire/explosion prevention)\n§236 (Hot-work permit control)',
    lawVi: 'Quy chuẩn ATVSLĐ §232 (Phòng cháy nổ)\n§236 (Kiểm soát công việc nóng)',
    lawAr: 'قاعدة السلامة §232 (الوقاية من الحريق/الانفجار)\n§236 (تحكم الأعمال الساخنة)',
    procedureKo: [
    ...
    procedureVi: [
      'Thông gió sau khi sơn cho đến LEL < 10%',
      'Tách công việc gây lửa ra ≥ 5 m và tách theo thời gian',
      'Cấp giấy phép công việc nóng; bình chữa cháy trong 1 m',
      'Liên tục giám sát LEL',
    ],
    procedureAr: [
      'تهوية بعد الدهان حتى LEL < 10%',
      'فصل أعمال الإشعال بمسافة ≥ 5 م وفصل زمني',
      'إصدار تصريح عمل ساخن؛ طفاية خلال 1 م',
      'مراقبة LEL باستمرار',
    ],
  },
  panel_drop: {
    ...
    descVi: 'Tấm vỏ rơi xuống do tháo giàn giáo và lắp tấm vỏ diễn ra đồng thời trên cùng tầng.',
    descAr: 'سقط لوح الواجهة بسبب تنفيذ تفكيك السقالة وتركيب الألواح في الطابق نفسه معاً.',
    ...
    causeVi: 'Tháo giàn giáo + lắp tấm vỏ đồng thời cùng tầng / không kiểm tra liên kết',
    causeAr: 'تفكيك السقالة + تركيب الألواح في الطابق نفسه / غياب فحص التثبيت',
    lawKo: '산업안전보건기준 제57조 (비계 해체 시 안전조치)\n제335조 (외장재 낙하 방지)',
    lawEn: 'OSH Rule §57 (Scaffold dismantling safety)\n§335 (Cladding fall prevention)',
    lawVi: 'Quy chuẩn ATVSLĐ §57 (An toàn khi tháo giàn giáo)\n§335 (Phòng vật liệu vỏ rơi)',
    lawAr: 'قاعدة السلامة §57 (سلامة تفكيك السقالة)\n§335 (منع سقوط ألواح الواجهة)',
    procedureKo: [
    ...
    procedureVi: [
      'Tách khu vực tháo dỡ và khu lắp tấm vỏ theo tầng/khu',
      'Kiểm tra mỏ neo tấm vỏ trước khi tháo giàn giáo',
      'Đặt vùng cấm tiếp cận bên dưới',
      'Người ra hiệu điều phối hai công việc',
    ],
    procedureAr: [
      'فصل منطقة التفكيك ومنطقة تركيب الألواح حسب الطابق/المنطقة',
      'التحقق من مثبتات الألواح قبل إزالة السقالة',
      'وضع منطقة منع تقدم أسفل',
      'مُوجِّه ينسق بين المهمتين',
    ],
  },
  swing_drop: {
    descKo: '강풍(10m/s 초과) 상태에서 양중작업을 강행하다 인양물이 흔들려 추락했습니다.',
    descEn: 'Lifted load swung and fell during high winds (>10 m/s).',
    descVi: 'Vật nâng đung đưa và rơi do gió mạnh (>10 m/s).',
    descAr: 'تأرجح الحمل المرفوع وسقط أثناء رياح شديدة (>10 م/ث).',
    causeKo: '풍속 한계 초과 / 작업중지 미실시 / 태그라인 미사용',
    causeEn: 'Wind limit exceeded / no work stop / no tag line',
    causeVi: 'Vượt giới hạn gió / không dừng việc / không dùng dây giằng',
    causeAr: 'تجاوز حد السرعة / عدم إيقاف العمل / غياب حبل التوجيه',
    ...
    lawVi: 'Quy chuẩn ATVSLĐ §37 (Cấm làm việc thời tiết xấu)\nTiêu chuẩn cẩu: ngừng khi gió > 10 m/s',
    lawAr: 'قاعدة السلامة §37 (منع العمل في الطقس السيء)\nمعيار الرافعة: إيقاف عند الرياح > 10 م/ث',
    procedureKo: [
    ...
    procedureVi: [
      'Liên tục theo dõi máy đo gió; dừng nếu > 10 m/s',
      'Dùng hai dây giằng để chống quay',
      'Xác nhận lại thời tiết trước khi tiếp tục',
      'Kiểm tra liên lạc người ra hiệu/lái cẩu',
    ],
    procedureAr: [
      'مراقبة مقياس الرياح باستمرار؛ إيقاف عند > 10 م/ث',
      'استخدام حبلين توجيهيين للسيطرة على الدوران',
      'إعادة التأكد من الطقس قبل الاستئناف',
      'فحص اتصال المُوجِّه والمشغّل',
    ],
  },
  premature_load: {
    ...
    descVi: 'Đổ sàn tầng trên trước khi sàn dưới đủ thời gian dưỡng hộ — sàn võng và sập.',
    descAr: 'بدأ صب الطابق العلوي قبل اكتمال معالجة البلاطة السفلية — البلاطة انحنت وانهارت.',
    causeKo: '양생기간 단축 / 압축강도 미측정 / 동바리 유지기간 미준수',
    causeEn: 'Inadequate cure time / no compressive strength test / shoring removed early',
    causeVi: 'Thời gian dưỡng hộ không đủ / không kiểm cường độ / tháo chống sớm',
    causeAr: 'وقت المعالجة غير كافٍ / عدم اختبار المقاومة / إزالة الدعامات مبكراً',
    ...
    lawVi: 'Quy chuẩn ATVSLĐ §334 (An toàn đổ bê tông)\nKCS 14 20 11 (tiêu chuẩn dưỡng hộ)',
    lawAr: 'قاعدة السلامة §334 (سلامة صب الخرسانة)\nKCS 14 20 11 (معيار المعالجة)',
    procedureKo: [
    ...
    procedureVi: [
      'Xác nhận cường độ sàn dưới ≥ 5 MPa trước khi làm tầng trên',
      'Duy trì chống đỡ trong số ngày dưỡng hộ (thường 14)',
      'Có báo cáo thử mẫu trụ',
      'Không rung lại hoặc quá tải',
    ],
    procedureAr: [
      'تحقق من قوة البلاطة السفلى ≥ 5 ميجا باسكال قبل العمل العلوي',
      'الإبقاء على الدعامات للأيام المطلوبة (عادة 14)',
      'الحصول على تقرير اختبار الأسطوانة',
      'منع الاهتزاز المتكرر أو التحميل الزائد',
    ],
  },
};
