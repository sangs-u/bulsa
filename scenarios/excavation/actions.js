...
const EXCAV_PHASE_MISSIONS = {
  ...
  3: { ko: '🔍 4개 코너 마커로 가서 E 키 길게 눌러 H-pile 점검 (1.8초)',
       en: '🔍 Walk to 4 corner markers, hold E to inspect H-pile (1.8s)' },
  4: { ko: '🛡 굴착 외곽 4개 슬롯에서 E 키로 안전난간 설치',
       en: '🛡 Walk to 4 perimeter slots and press E to install railings' },
  5: { ko: '🦺 작업반경 밖 적합 위치에서 E 키로 신호수 배치',
       en: '🦺 Stand outside swing radius and press E to place signal person' },
